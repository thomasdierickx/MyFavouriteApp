        ...
        <>
            <BackButton />
            {
                categories === null ?
                    ...
                    <Container>
                        <Typography variant="h2" component="h1">{categories.data[3].attributes.name}</Typography>
                        {error && <Alert severity="error">Something went wrong</Alert>}
                        <Stack spacing={2}>
                            {categories.data[3].attributes.restaurants && categories.data[3].attributes.restaurants.data.map((category, i) =>
